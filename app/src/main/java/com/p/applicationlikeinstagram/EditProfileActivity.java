...
public class EditProfileActivity extends AppCompatActivity {
    ...
    private TextView txtSave, txtChangePhoto;
    private MaterialEditText metFullName, metUsername, metBio;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtChangePhoto = findViewById(R.id.change_photo);
        txtSave = findViewById(R.id.save);
        metFullName = findViewById(R.id.full_name);
        ...
        FirebaseDatabase.getInstance().getReference().child("users").child(fUser.getUid())
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        metFullName.setText(user.getName());
        ...
        civImageProfile.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                CropImage.activity().setCropShape(CropImageView.CropShape.OVAL).start(EditProfileActivity.this);
            }
    ...
    private void updateProfile() {
        ...
        map.put("name" , metFullName.getText().toString());
        map.put("username", metUsername.getText().toString());
        map.put("bio", metBio.getText().toString());
